...
const api: DesktopApi = {
  ...
  activateModelRecord: (recordId) => ipcRenderer.invoke("model:activate", recordId),
  deleteModelRecord: (recordId) => ipcRenderer.invoke("model:delete", recordId),
  testModel: (input) => ipcRenderer.invoke("model:test", input),
  apiCallRecords: (projectPath, limit) => ipcRenderer.invoke("usage:api-calls", projectPath, limit),
